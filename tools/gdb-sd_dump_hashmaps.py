...
class sd_dump_hashmaps(gdb.Command):
    ...
    def invoke(self, arg, _from_tty):
        ...
        while d:
            ...
            print(
                f'{t}, {h["hash_ops"]}, {bool(h["has_indirect"])}, {n_entries}, {d["max_entries"]}, {n_buckets}, {d["func"].string()}, {d["file"].string()}:{d["line"]}'
            )
            ...
            if arg != '' and n_entries > 0:
                ...
                for dib in sorted(histogram):
                    if dib != 255:
                        print(
                            f'{dib:>3} {histogram[dib]:>8} {float(histogram[dib]/n_entries):.0%} of entries'
                        )
                    else:
