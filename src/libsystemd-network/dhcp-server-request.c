...
static int dhcp_server_process_message(sd_dhcp_server *server, const struct iovec *iov, const triple_timestamp *timestamp) {
        int r;
...
static int dhcp_server_relay_message(sd_dhcp_server *server, const struct iovec *iov) {
        int r;
