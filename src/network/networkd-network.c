...
int network_verify(Network *network) {
        ...
        if (network->bond) {
                ...
                network->addresses_by_section = ordered_hashmap_free_with_destructor(network->addresses_by_section, address_detach);
...
static Network *network_free(Network *network) {
        ...
        ordered_hashmap_free_with_destructor(network->addresses_by_section, address_detach);
