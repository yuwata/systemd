...
TEST(tpm2b_public_to_openssl_pkey) {
        ...
        _cleanup_(EVP_PKEY_CTX_freep) EVP_PKEY_CTX *ctx_rsa = sym_EVP_PKEY_CTX_new((EVP_PKEY*) pkey_rsa, NULL);
        assert_se(ctx_rsa);
        ...
        _cleanup_(EVP_PKEY_CTX_freep) EVP_PKEY_CTX *ctx_ecc = sym_EVP_PKEY_CTX_new((EVP_PKEY*) pkey_ecc, NULL);
        assert_se(ctx_ecc);
