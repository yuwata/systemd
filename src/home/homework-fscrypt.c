...
static int fscrypt_slot_try_one(
        ...
        if (sym_EVP_DecryptFinal_ex(context, (uint8_t*) decrypted_size + decrypted_size_out1, &decrypted_size_out2) != 1)
...
static int fscrypt_slot_set(
        ...
        if (sym_EVP_EncryptFinal_ex(context, (uint8_t*) encrypted_size + encrypted_size_out1, &encrypted_size_out2) != 1)
