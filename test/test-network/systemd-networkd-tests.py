...
class NetworkdRATests(unittest.TestCase, Utilities):
    ...
    def test_ndisc_redirect(self):
        ...
        check_output(f'{test_ndisc_send} --interface veth-peer --type redirect --target-address 2002:da8:1::2 --redirect-destination 2002:da8:1:2:1a:2b:3c:4d')
        self.wait_route('veth99', r'2002:da8:1:2:1a:2b:3c:4d via 2002:da8:1::2 proto redirect', ipv='-6', timeout_sec=10)
        output = check_output('ip -6 route show dev veth99 proto redirect')
        self.assertNotIn('vie 2002:da8:1::1', output)
        ...
        check_output(f'{test_ndisc_send} --interface veth-peer --type neighbor-advertisement --target-address {veth_peer_ipv6ll}')
        self.wait_route('veth99', 'proto redirect', ipv='-6', timeout_sec=10)
